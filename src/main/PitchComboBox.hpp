...
#ifndef PITCHCOMBOBOX_HPP
#define PITCHCOMBOBOX_HPP PITCHCOMBOBOX_HPP
...
*/
class PitchComboBox : public QComboBox
{
   Q_OBJECT
...
public:
   /*!
    ...
    \param parent
   */
   explicit PitchComboBox( QWidget *parent = 0 );
   /*!
    \brief destructor

   */
   virtual ~PitchComboBox();
   /*!
